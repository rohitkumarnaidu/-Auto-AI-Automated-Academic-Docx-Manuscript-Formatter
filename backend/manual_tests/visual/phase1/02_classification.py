...
COLOR_MAP = {
    ...
    BlockType.ACKNOWLEDGEMENTS: WD_COLOR_INDEX.VIOLET,
    BlockType.FUNDING: WD_COLOR_INDEX.VIOLET,
    BlockType.CONFLICT_OF_INTEREST: WD_COLOR_INDEX.VIOLET,
    BlockType.FOOTNOTE: WD_COLOR_INDEX.GRAY_50,
}
