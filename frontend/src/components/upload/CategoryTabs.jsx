            ...
            <div className="w-full overflow-x-auto pb-1">
                <div className="flex min-w-max bg-slate-100 dark:bg-slate-800/50 p-1.5 rounded-xl shadow-inner mx-auto">
                    ...
                    <button
                        disabled
                        aria-disabled="true"
                        className="px-5 sm:px-8 py-2.5 rounded-lg text-slate-500 dark:text-slate-400 text-sm font-medium bg-slate-200/50 dark:bg-slate-700/40 cursor-not-allowed opacity-80 flex items-center whitespace-nowrap"
                    >
                        Resume
